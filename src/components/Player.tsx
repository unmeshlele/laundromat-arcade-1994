  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 px-3 pb-4 sm:pb-8 pointer-events-none">
      <div className="max-w-xl mx-auto pointer-events-auto flex flex-col items-center gap-2">
        ...
        {/* The Deluxe Saloon Rounded Glass Player Pill */}
        <div className="w-full bg-[#140e24]/85 backdrop-blur-2xl rounded-full p-2 pr-3 sm:p-2.5 sm:pr-5 border border-white/20 shadow-[0_12px_40px_rgba(0,0,0,0.8),0_0_20px_rgba(255,42,141,0.2)] flex items-center gap-3 sm:gap-4">
          
          {/* Rotating Album Art / Cassette Thumbnail */}
          <div className="relative size-11 sm:size-13 shrink-0 rounded-full overflow-hidden bg-black/60 border border-white/20 flex items-center justify-center shadow-md">
            <img
            ...
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
              <span className={`text-sm ${isPlaying ? 'animate-spin' : ''}`} style={{ animationDuration: '4s' }}>
                📼
              </span>
            </div>
          </div>

          {/* Song Meta & Inline Seekbar */}
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-1.5">
              <p className="truncate text-xs sm:text-sm font-semibold text-white font-['Outfit']">
                {currentSong.titleEn}
              </p>
              <span className="shrink-0 text-[0.65rem] text-[#00f0ff] font-medium hidden sm:inline">
                {currentSong.titleNative}
              </span>
            </div>

            <div className="flex items-center gap-1.5 text-[0.65rem] sm:text-xs text-white/60">
              <span className="truncate">{currentSong.artistEn}</span>
              <span>·</span>
              <button
          ...
          <div className="flex shrink-0 items-center gap-1 sm:gap-2">
            ...
            <button
              ...
              className="size-9 sm:size-10 rounded-full bg-gradient-to-tr from-[#ff2a8d] to-[#aa3bff] text-white flex items-center justify-center shadow-[0_0_15px_rgba(255,42,141,0.6)] hover:scale-105 active:scale-95 transition-all cursor-pointer"
          ...
          <div className="flex shrink-0 items-center gap-1 border-l border-white/10 pl-2">
            <button
              ...
              title="Adjust Rain & Dryer Background Ambience"
            >
